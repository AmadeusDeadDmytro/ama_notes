const colors = {
    ...
    A_COLOR_FIVE: (darkTheme = false) => (darkTheme ? '#111111' : '#8ba7f4'), /// bbb
    A_COLOR_SIX: (darkTheme = false) => (darkTheme ? '#b8b8b8' : '#F2E49B'), /// 222
    A_COLOR_SEVEN: (darkTheme = false) => (darkTheme ? '#777676' : '#5a1810'), /// 202020
    A_COLOR_EIGHT: (darkTheme = false) => (darkTheme ? '#ecebeb' : '#fdde6c'), /// 6ab0f3
    A_COLOR_NINE: (darkTheme = false) => (darkTheme ? '#ecebeb' : '#F8f22f'), /// ccc
